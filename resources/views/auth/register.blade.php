                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-maderalpes-dark">
                                Acepto los <a href="#" class="text-maderalpes-green hover:text-maderalpes-gold">Términos y Condiciones</a> y la <a href="#" class="text-maderalpes-green hover:text-maderalpes-gold">Política de Privacidad</a>
                            </label>
                        </div>
                    </div>
